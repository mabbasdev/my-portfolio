...
Theme Name: Gavin - Personal Portfolio HTML5 Template
Theme URI: 
Author: MrFrenzy Websites
Author URI: https://themeforest.net/user/Deviconix/portfolio/
Description: Gavin - Personal Portfolio HTML5 Template
...
(function ($) {
  ...
  $(window).on("load", function () {
    ...
    function splitTextToSpans(targetElement) {
      if (targetElement) {
        const text = targetElement.textContent.trim().replace(/\s+/g, " "); // Trim & normalize spaces
